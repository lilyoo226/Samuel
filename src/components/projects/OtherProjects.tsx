          ...
          <div className="other__card">
            ...
            <div className="other__cardBody">
              ...
              <p className="other__cardBodyDescription">
                Responsive pizza restaurant food ordering app UI design using
                React | Next.js. Design restaurant app using React Next.js and
                CSS. Next.js MongoDB restaurant (order food) project using React
                Redux. Full-stack Next.js APP.{" "}
              </p>
            </div>
            <div className="other__cardFooter">
              <div className="other__tags">
                {" "}
                Material UI &nbsp; Nextjs &nbsp; Mongodb &nbsp; jwt-auth
              </div>
            </div>
          </div>
        </li>
        <li className="other__items">
          <div className="other__card">
            ...
            <div className="other__cardBody">
              ...
              <p className="other__cardBodyDescription">
                Notebook is made from the pain of writing all the things in
                notebook which is very hectic. So we made a online web platform
                where you can create,edit, upload,delete your notes /
                information privately and securely without any disturbancee,you
                can also access your notes anywhere in your world,at anytime
                time.
              </p>
            </div>
            <div className="other__cardFooter">
              <div className="other__tags">
                {" "}
                Material UI &nbsp; React &nbsp; MongoDB &nbsp; Expressjs
              </div>
            </div>
          </div>
        </li>
        <li className="other__items">
          <div className="other__card">
            ...
            <div className="other__cardBody">
              ...
              <p className="other__cardBodyDescription">
                Natours. An awesome tour booking site built on top of NodeJS. A
                Web design of tours and travelling usingAdvanced css i.e SCSS /
                SASS
              </p>
            </div>
            <div className="other__cardFooter">
        ...
        <li className="other__items">
          <div className="other__card">
            <div className="other__cardTop">
              ...
              <div className="other__cardLink">
                <a
                  href="https://github.com/yashfalke77/Ping-Pong-Score-Keeper"
                  target="_blank"
                  rel="noreferrer"
                  style={{ marginRight: "1.6rem" }}
                >
                ...
                <a
                  href="https://codepen.io/yashfalke77/pen/KKqpgzN"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg className="other__icon">
        ...
        <li className="other__items">
          <div className="other__card">
            <div className="other__cardTop">
              ...
              <div className="other__cardLink">
                <a
                  href="https://github.com/pico-india/main-django"
                  target="_blank"
                  rel="noreferrer"
                  style={{ marginRight: "1.6rem" }}
                >
                ...
                <a
                  href="https://youtu.be/HI5fYKvuo-8"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg className="other__icon">
            ...
            <div className="other__cardBody">
              <div className="other__cardBodyHeading">
                Pico - A photo library website
              </div>
              <p className="other__cardBodyDescription">
                Pico is a website dedicated to sharing stock photography under
                the Pico license. Pico allows photographers to upload photos to
                its website, which are then curated by a team of photo editors.
                In Pico we are aspiring to be one of the largest photography
