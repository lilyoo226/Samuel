        ...
        <nav className="navbar">
            ...
            <div className="navbar__right">
                <ul className="navbar__list">
                    ...
                    <li className="navbar__items">
                        <a href="/#project" className="navbar__itemsLink"><span className="navbar__itemsLinkNumeric">03.</span>.work()</a>
                    </li>
                    <li className="navbar__items">
                        <a href="/contact" className="navbar__itemsLink"><span className="navbar__itemsLinkNumeric">04.</span>.contact()</a>
                    </li>
                </ul>
                <a href="RESUME HERE" target="_blank" rel='noreferrer' className="navbar__button">Resume</a>
            </div>
        </nav>
    )
}
